...
`,
  steps: [
    ...
    },
    {
      ...
      graph: {
        nodes: createSampleGraph().nodes.map(node => 
          node.id === 'A' || node.id === 'B' ? { ...node, state: 'visited' } : 
    ...
    },
    {
      ...
      graph: {
        nodes: createSampleGraph().nodes.map(node => 
          node.id === 'A' || node.id === 'B' || node.id === 'D' ? { ...node, state: 'visited' } : 
    ...
    },
    {
      ...
      graph: {
        nodes: createSampleGraph().nodes.map(node => 
          node.id === 'A' || node.id === 'B' || node.id === 'D' || node.id === 'E' ? { ...node, state: 'visited' } : 
    ...
    },
    {
      ...
      graph: {
        nodes: createSampleGraph().nodes.map(node => 
          node.id === 'A' || node.id === 'B' || node.id === 'D' || node.id === 'E' || node.id === 'F' ? { ...node, state: 'visited' } : 
