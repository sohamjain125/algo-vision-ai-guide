...
console.log('Previous:', previous);`,
  ...
  steps: [
    ...
    },
    {
      ...
      graph: {
        nodes: createSampleGraph().nodes.map(node => 
          node.id === 'A' || node.id === 'C' ? { ...node, state: 'visited' as NodeState } : 
    ...
    },
    {
      ...
      graph: {
        nodes: createSampleGraph().nodes.map(node => 
          node.id === 'A' || node.id === 'C' || node.id === 'B' ? { ...node, state: 'visited' as NodeState } : 
    ...
    },
    {
      ...
      graph: {
        nodes: createSampleGraph().nodes.map(node => 
          node.id === 'A' || node.id === 'C' || node.id === 'B' || node.id === 'D' ? { ...node, state: 'visited' as NodeState } : 
    ...
    },
    {
      ...
      graph: {
        nodes: createSampleGraph().nodes.map(node => 
          node.id === 'A' || node.id === 'C' || node.id === 'B' || node.id === 'D' || node.id === 'E' ? { ...node, state: 'visited' as NodeState } : 
